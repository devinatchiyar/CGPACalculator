...
public class Activity8 extends AppCompatActivity implements OnClickListener
{
    //Defining the Views
    EditText Num1;
    EditText Num2;
    ...
    public void onClick (View v)
    {
        ...
        num8 = Float.parseFloat(Num8.getText().toString());

        // defines the button that has been clicked and performs the corresponding operation
        // write operation into oper, we will use it later for output
        result=((num1*26)+(num2*28)+(num3*27)+(num4*25)+(num5*25)+(num6*24)+(num7*22)+(num8*12))/(26+28+27+25+25+24+22+12);
